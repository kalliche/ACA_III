...
#leer los archivos
file.choose()
octubre_2023 <- read.csv("/home/carlos-garcia/Descargas/aca final/Octubre 2023 exportaciones CoL1.csv")
septiembre_2023 <- read.csv("/home/carlos-garcia/Descargas/aca final/Septiembre 2023 exportaciones Col 1.csv")
